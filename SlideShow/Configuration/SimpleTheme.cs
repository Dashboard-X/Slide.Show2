...
{
	/// <summary>
	/// Represents a SimpleTheme
	/// </summary>
	public class SimpleTheme : ConfigurationProvider
	{
		/// <summary>
		...
		public SimpleTheme(Dictionary<string, Dictionary<string, string>> initParams)
		{
		}
