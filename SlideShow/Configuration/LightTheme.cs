...
namespace Vertigo.SlideShow
{
	...
	public class LightTheme : ConfigurationProvider
	{
		...
		public LightTheme(Dictionary<string, Dictionary<string, string>> initParams)
		{
		}
		...
		protected override void GetConfiguration()
		{
			...
			Options.EmbedViewer = new Options.EmbedViewerOptions()
			{
				...
				DialogBackground = ParseBrush("#536987"),
				DialogBackgroundOpacity = .8,
				DialogBorderBrush = ParseBrush("#000080"),
				DialogBorderThickness = new Thickness(2),
				DialogWidth = 620,
				DialogHeight = 250,

				CloseButtonBackground1Brush = ParseBrush("#273B5B"),
				CloseButtonBackground2Brush = ParseBrush("#6A75A2"),
				...
				HyperlinkButtonBackground = ParseBrush("#536987"),
				...
				TextBlockMargin = new Thickness(20, 0, 0, 0),
			...
			{
				Background = ParseBrush("#273B5B"),
				BackgroundHover = ParseBrush("#6A75A2"),
